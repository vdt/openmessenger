		...
		<div id="news-wrapper">
			<div class="news-items">
				<div class="rows row-1">
					<div class="news-writer">Biggest Tiger's Fang</div>					
					<div class="news-title">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec rutrum augue in est euismod consectetur.</div>
					<div class="news-date">26 july 2011</div>
				</div>
			</div>
