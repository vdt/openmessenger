                    ...
                    <table>
                        <tbody>
							...
							<tr class="prop">
								...
								<td valign="top" >
									<g:checkBox value="${auth.id}" name="auth.authority" checked="${userInstance?.authorities.find{it.id==auth.id}}"/>
							...
							<tr class="prop">
								...
								<td valign="top" >
									<g:checkBox value="${event.id}" name="event" checked="${userInstance?.events.find{it.id==event.id}}"/>
